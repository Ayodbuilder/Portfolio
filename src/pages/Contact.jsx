...
function Contact() {
  return (
    <section className="relative min-h-screen py-10 md:py-16 text-white overflow-hidden px-4">
      ...
      {/* Glass Container */}
      <motion.div
        className="relative max-w-4xl mx-auto bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 md:p-10"
      ...
      >
        ...
        <p className="text-gray-400 mb-10 text-center text-sm md:text-base">
        ...
        <div className="flex justify-center gap-4 md:gap-6 mb-12 flex-wrap">
          ...
          <motion.a
            ...
            className="flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/10 px-4 md:px-5 py-3 rounded-lg text-sm md:text-base"
          >
            <FaEnvelope />
            Email
          </motion.a>
        ...
        >
          ...
          <motion.button
            ...
            type="submit"
            className="w-full md:w-auto bg-white text-black px-6 py-3 rounded-lg font-medium transition hover:bg-gray-300"
          >
            Send Message
          </motion.button>
