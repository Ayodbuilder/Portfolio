...
<section className="relative min-h-screen py-10 text-white overflow-hidden">
...
{/* Glass Container */}
<div className="relative max-w-6xl mx-auto bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-8">
...
viewport={{once:true}}
className="cursor-pointer bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-xl transition transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/30 duration-300"
>
...
className="bg-white text-black px-4 py-2 rounded-lg text-sm flex items-center gap-2"
>
<Github size={16}/>
View Code
</a>
...
target="_blank"
onClick={(e)=>e.stopPropagation()}
className="border border-white px-4 py-2 rounded-lg text-sm hover:bg-white hover:text-black"
>
Visit Website
</a>
...
<motion.div
className="bg-gray-900 rounded-2xl max-w-xl w-full p-6 border border-white/10"
