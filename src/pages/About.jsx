    ...
    <section className="relative min-h-screen flex items-center text-white overflow-hidden px-4 md:px-8 py-16">
      ...
      >
        ...
        <p className="text-gray-300 leading-relaxed mb-6">
          ...
          I am a writer as well, sharing my knowledge through technical articles and exploring creative storytelling through fiction. I believe in continuous learning and i'm always excited to take on new challenges in the world of web development and writing.
        </p>
